...
ister), 1–2 gün canın istediği kadar (istersen hiç) oynaman ve sonunda 3 dakikalık, 5 soruluk bir formu
doldurman. Beğeni/puan sorusu YOK — ne hissettiğini değil, ne YAPTIĞINI soruyorum. Oyun anonim kullanım
istatistiği toplar (ne zaman açıldı, nerede bırakıldı); kişisel veri, rehber, fotoğraf vb. erişim istemez;
kayıtlar anonimdir — istersen kaydının silinmesini talep edebilirsin. İstediğin an bırakabilirsin; formu
doldurmasan da söylemen yeterli (o da veridir). İstersen senin bir projeni de aynı dikkatle denerim —
karşılıklı playtest usulü. Teşekkürler!
...
- Yanlılık kabulü: Play-dışı kurulum sabır/güven eşiği yüksek kişileri seçer — ölçüm bu filtrelenmiş
  ...
  kuralıyla). iOS elemesi büyükse kapalı-track veri geldiğinde tartışılır — şimdi DEĞİL (A3.4).
