...
**Sürüm:** v0.11 — G1/G2 yeniden çerçevelemesi + dosya bölmesi (B4 kapanışı) + C1–C5.
...
| Mevcut oyun ilişkisi | **Varsayılan A: temiz tut** — hattan ayrı; B (çapraz tanıtım) yalnız kullanıcının açık onayıyla | 4.3/spam incelemesi hesaptaki TÜM uygulamaları torbalar; çalışan oyun riske açık onay olmadan sokulmaz |
...
8. **Para ve kuyu:** hat standart akışta **para harcamaz ve çapraz tanıtım
   kullanmaz**. İkisi de yalnız Aşama 10 yatırım ofisi üzerinden, kullanıcı onayıyla,
   Ek C Bölüm-2 sınırları içinde açılır. Hat bütçe üretmez, ölçer; Ek C'de olmayan
   sayı hiçbir kapıda kullanılamaz.
...
| `docs/stages/0.md` | 0 (tek seferlik) | Kurulum (0A) ve pilot koşu (0B) |
